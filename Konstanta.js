...
const KONSTANTA = {
  // Objek baru untuk mendefinisikan semua Aksi yang mungkin
  ACTIONS: {
    // Aksi Navigasi & Tampilan
    VIEW_LIST: 'VIEW_LIST',
    VIEW_VM_DETAIL: 'VIEW_VM_DETAIL',
    VIEW_DS_DETAIL: 'VIEW_DS_DETAIL',
    PAGINATE: 'PAGINATE',
    GO_BACK: 'GO_BACK',

    // Aksi Terkait Catatan
    PROMPT_NOTE_INPUT: 'PROMPT_NOTE_INPUT',
  ...
  CALLBACK_CEKVM: {
    PREFIX: 'cekvm_',
    // Prefix eksplisit untuk setiap aksi di halaman pencarian VM
    SEARCH_NAV_PREFIX: "cekvm_search_nav_",      // Untuk navigasi hasil pencarian
    SEARCH_EXPORT_PREFIX: "cekvm_search_export_",// Untuk ekspor hasil pencarian
  ...
  // Callback rekomendasi setup
  CALLBACK_REKOMENDASI: {
    PREFIX: 'reco_',
    PILIH_KRITIKALITAS: 'reco_crit_',
    PILIH_IO: 'reco_io_',
    BATAL: 'reco_cancel'
  },
